...
function DigestManagement() {
  ...
  const handleCreateDigest = async (e: React.FormEvent): Promise<void> => {
    e.preventDefault();
  ...
  const handleToggleDigest = async (digestId: string): Promise<void> => {
    try {
  ...
  const handleTriggerRun = async (digestId: string): Promise<void> => {
    try {
              ...
              >
                ...
                >
                  ...
                  <button
                    ...
                    disabled={
                      isCreating || !formData.name.trim() || !formData.query.trim()
                    }
                  >
          ...
          {digests.map((digest) => (
            ...
            >
              ...
              >
                ...
                <span
                  className={`badge ${digest.is_active ? 'badge-success' : 'badge-default'}`}
                >
